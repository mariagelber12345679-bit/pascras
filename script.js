...
// Проверка загрузки картинки sourceImage.onload = () => { console.log("Фото успешно загружено!"); }; sourceImage.onerror = () =>
{ console.error("Ошибка: Файл photo.jpg не найден. Проверьте имя файла в GitHub."); sourceImage.alt = "Файл photo.jpg не найден!"; };